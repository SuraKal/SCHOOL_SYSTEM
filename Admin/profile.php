...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"INSERT into tbladmin(emailAddress,password) 
    value('$emailAddress','$password')");
    }
}
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
                ...
                $query=mysqli_query($conn,"update tbladmin set emailAddress='$emailAddress', password='$password'
                where Id='$Id'");
                if ($query) {
