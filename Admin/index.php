...
include '../Includes/session.php';
  ...
  //Message
$statusMsg = '';
  if(isset($_SESSION['LINKnotFound'])){
      $statusMsg = "<div class='alert alert-danger'  style='margin-right:700px;'>Link not found</div>";
      unset($_SESSION['LINKnotFound']);
  }
...
<head>
  ...
  <link href="img/logo/arrnlg.jpg" rel="icon">
  <title>Ennlite|Admin|Dashboard</title>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Batchs</div>
